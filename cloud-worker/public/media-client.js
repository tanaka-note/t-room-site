(function (global) {
  ...
  async function registerMedia(file, fileKey, endpoint) {
    ...
    worker.postMessage({ type: "REGISTER_MEDIA", token, descriptor, fileKey });
  ...
  async function initializeWorker() {
    ...
    const registration = await navigator.serviceWorker.register("/cloud/media-worker.js?v=20260808-2", { scope: "/cloud/", updateViaCache: "none" });
