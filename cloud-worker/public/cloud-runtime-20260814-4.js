...
function addPreviewPlayerControls(stage, video, file) {
  ...
  for (const eventName of ["loadedmetadata", "durationchange", "timeupdate", "progress", "canplay", "seeked"]) video.addEventListener(eventName, queuePlaybackSync);
