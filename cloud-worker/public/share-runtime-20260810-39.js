...
async function prepareInstalledVideoFullscreen(sourceVideo = null) {
  ...
  try {
    ...
    if (requestGeneration !== state.previewOrientationGeneration || !sharedPreviewVideoIsFullscreen(sourceVideo)) {
      await restoreInstalledAppPortrait();
    }
  } catch {}
}
