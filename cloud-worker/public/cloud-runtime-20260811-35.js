const API = "/cloud/api";
const APP_BUILD_ID = "20260811-35";
...
function addPreviewPlayerControls(stage, video, file) {
  ...
  seek.addEventListener("pointerdown", (event) => {
    ...
    previewSeek(seekPointerStartSeconds);
  ...
  seek.addEventListener("pointermove", (event) => {
    ...
    previewSeek(relativeSeekTime(seekPointerStartSeconds, seekPointerStartX, event.clientX, width, video.duration));
  });
