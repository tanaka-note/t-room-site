...
importScripts("/cloud/crypto-vault.js?v=cloud-d9ba0bfb7197");
importScripts("/cloud/media-range.js?v=cloud-d9ba0bfb7197");
importScripts("/cloud/offline-store.js?v=cloud-d9ba0bfb7197");

const registrations = new Map();
const RETRY_DELAYS = [0, 400, 1200, 3000];
const APP_SHELL_CACHE = "tcloud-shell-cloud-d9ba0bfb7197";
const MEDIA_WORKER_BUILD_ID = "cloud-d9ba0bfb7197";
...
const APP_SHELL_ASSETS = [
  ...
  "/cloud/offline-store.js?v=cloud-d9ba0bfb7197",
...
function shouldWarmTail(descriptor) {
  if (descriptor.containerType) return descriptor.containerType === "mp4" || descriptor.containerType === "quicktime" || descriptor.containerType === "webm";
