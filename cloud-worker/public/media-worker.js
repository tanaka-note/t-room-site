...
importScripts("/cloud/crypto-vault.js?v=cloud-95e09142437f");
importScripts("/cloud/media-range.js?v=cloud-95e09142437f");
importScripts("/cloud/offline-store.js?v=cloud-95e09142437f");

const registrations = new Map();
const RETRY_DELAYS = [0, 400, 1200, 3000];
const APP_SHELL_CACHE = "tcloud-shell-cloud-95e09142437f";
const MEDIA_WORKER_BUILD_ID = "cloud-95e09142437f";
...
const APP_SHELL_ASSETS = [
  ...
  "/cloud/offline-store.js?v=cloud-95e09142437f",
