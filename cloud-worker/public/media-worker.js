...
importScripts("/cloud/crypto-vault.js?v=cloud-5b18440c289d");
importScripts("/cloud/media-range.js?v=cloud-5b18440c289d");
importScripts("/cloud/offline-store.js?v=cloud-5b18440c289d");

const registrations = new Map();
const RETRY_DELAYS = [0, 400, 1200, 3000];
const APP_SHELL_CACHE = "tcloud-shell-cloud-5b18440c289d";
const MEDIA_WORKER_BUILD_ID = "cloud-5b18440c289d";
...
const APP_SHELL_ASSETS = [
  ...
  "/cloud/offline-store.js?v=cloud-5b18440c289d",
