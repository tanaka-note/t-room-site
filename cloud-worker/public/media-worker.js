...
importScripts("/cloud/crypto-vault.js?v=cloud-bb654832ec3f");
importScripts("/cloud/media-range.js?v=cloud-bb654832ec3f");
importScripts("/cloud/offline-store.js?v=cloud-bb654832ec3f");

const registrations = new Map();
const RETRY_DELAYS = [0, 400, 1200, 3000];
const APP_SHELL_CACHE = "tcloud-shell-cloud-bb654832ec3f";
const MEDIA_WORKER_BUILD_ID = "cloud-bb654832ec3f";
...
const APP_SHELL_ASSETS = [
  ...
  "/cloud/offline-store.js?v=cloud-bb654832ec3f",
