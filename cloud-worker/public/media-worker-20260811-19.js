...
importScripts("/cloud/crypto-vault.js?v=cloud-81eefad3aae4");
importScripts("/cloud/media-range.js?v=cloud-81eefad3aae4");
importScripts("/cloud/offline-store.js?v=cloud-81eefad3aae4");

const registrations = new Map();
const RETRY_DELAYS = [0, 400, 1200, 3000];
const APP_SHELL_CACHE = "tcloud-shell-cloud-81eefad3aae4";
const MEDIA_WORKER_BUILD_ID = "cloud-81eefad3aae4";
...
const APP_SHELL_ASSETS = [
  ...
  "/cloud/offline-store.js?v=cloud-81eefad3aae4",
