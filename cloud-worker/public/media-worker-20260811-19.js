...
importScripts("/cloud/crypto-vault.js?v=cloud-688d35f2d677");
importScripts("/cloud/media-range.js?v=cloud-688d35f2d677");
importScripts("/cloud/offline-store.js?v=cloud-688d35f2d677");

const registrations = new Map();
const RETRY_DELAYS = [0, 400, 1200, 3000];
const APP_SHELL_CACHE = "tcloud-shell-cloud-688d35f2d677";
const MEDIA_WORKER_BUILD_ID = "cloud-688d35f2d677";
...
const APP_SHELL_ASSETS = [
  ...
  "/cloud/offline-store.js?v=cloud-688d35f2d677",
