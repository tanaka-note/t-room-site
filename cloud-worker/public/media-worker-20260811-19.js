...
importScripts("/cloud/crypto-vault.js?v=cloud-038e443e5b1f");
importScripts("/cloud/media-range.js?v=cloud-038e443e5b1f");
importScripts("/cloud/offline-store.js?v=cloud-038e443e5b1f");

const registrations = new Map();
const RETRY_DELAYS = [0, 400, 1200, 3000];
const APP_SHELL_CACHE = "tcloud-shell-cloud-038e443e5b1f";
const MEDIA_WORKER_BUILD_ID = "cloud-038e443e5b1f";
...
const APP_SHELL_ASSETS = [
  ...
  "/cloud/offline-store.js?v=cloud-038e443e5b1f",
