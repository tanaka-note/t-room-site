...
importScripts("/cloud/crypto-vault.js?v=cloud-3c435f565a4a");
importScripts("/cloud/media-range.js?v=cloud-3c435f565a4a");
importScripts("/cloud/offline-store.js?v=cloud-3c435f565a4a");

const registrations = new Map();
const RETRY_DELAYS = [0, 400, 1200, 3000];
const APP_SHELL_CACHE = "tcloud-shell-cloud-3c435f565a4a";
const MEDIA_WORKER_BUILD_ID = "cloud-3c435f565a4a";
...
const APP_SHELL_ASSETS = [
  ...
  "/cloud/offline-store.js?v=cloud-3c435f565a4a",
