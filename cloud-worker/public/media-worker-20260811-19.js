...
importScripts("/cloud/crypto-vault.js?v=cloud-b981860295ac");
importScripts("/cloud/media-range.js?v=cloud-b981860295ac");
importScripts("/cloud/offline-store.js?v=cloud-b981860295ac");

const registrations = new Map();
const RETRY_DELAYS = [0, 400, 1200, 3000];
const APP_SHELL_CACHE = "tcloud-shell-cloud-b981860295ac";
const MEDIA_WORKER_BUILD_ID = "cloud-b981860295ac";
...
const APP_SHELL_ASSETS = [
  ...
  "/cloud/offline-store.js?v=cloud-b981860295ac",
