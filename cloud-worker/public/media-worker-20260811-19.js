...
importScripts("/cloud/crypto-vault.js?v=cloud-30deacacd55c");
importScripts("/cloud/media-range.js?v=cloud-30deacacd55c");
importScripts("/cloud/offline-store.js?v=cloud-30deacacd55c");

const registrations = new Map();
const RETRY_DELAYS = [0, 400, 1200, 3000];
const APP_SHELL_CACHE = "tcloud-shell-cloud-30deacacd55c";
const MEDIA_WORKER_BUILD_ID = "cloud-30deacacd55c";
...
const APP_SHELL_ASSETS = [
  ...
  "/cloud/offline-store.js?v=cloud-30deacacd55c",
