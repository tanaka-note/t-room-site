...
importScripts("/cloud/crypto-vault.js?v=cloud-fffffbab25ec");
importScripts("/cloud/media-range.js?v=cloud-fffffbab25ec");
importScripts("/cloud/offline-store.js?v=cloud-fffffbab25ec");

const registrations = new Map();
const RETRY_DELAYS = [0, 400, 1200, 3000];
const APP_SHELL_CACHE = "tcloud-shell-cloud-fffffbab25ec";
const MEDIA_WORKER_BUILD_ID = "cloud-fffffbab25ec";
...
const APP_SHELL_ASSETS = [
  ...
  "/cloud/offline-store.js?v=cloud-fffffbab25ec",
