...
assert.match(html, /id="move-submit"[^>]*type="button"/);
...
assert.match(client, /submit\.disabled = false;/);
assert.match(client, /\$\("#move-submit"\)\?\.addEventListener\("click", moveSelectedItems\)/);
