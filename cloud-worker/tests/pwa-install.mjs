...
assert.ok(manifest.icons.every((icon) => icon.src.includes("-v2.png")), "既存PWAへ新しいアイコンURLを通知してください。");

assert.match(html, /rel="manifest" href="\/cloud\/manifest-v2\.webmanifest"/);
...
assert.match(worker, /icon-192-v2\.png/);
