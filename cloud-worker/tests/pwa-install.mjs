...
for (const [source, runtime] of [
  ["cloud.js", "cloud-runtime-20260811-14.js"],
  ...
  ["media-worker.js", "media-worker-20260811-5.js"],
...
assert.match(html, /name="tcloud-build" content="20260811-14"/);
...
assert.match(client, /const APP_BUILD_ID = "20260811-14"/);
...
assert.match(worker, /tcloud-shell-20260811-5/);
