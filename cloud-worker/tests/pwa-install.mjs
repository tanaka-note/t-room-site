...
for (const [source, runtime] of [
  ["cloud.js", "cloud-runtime-20260811-13.js"],
  ["cloud.css", "cloud-runtime-20260811-7.css"],
  ["offline-store.js", "offline-store-20260811-2.js"],
  ["media-client.js", "media-client-20260811-2.js"],
  ["media-worker.js", "media-worker-20260811-4.js"],
...
assert.match(html, /name="tcloud-build" content="20260811-13"/);
...
assert.match(client, /const APP_BUILD_ID = "20260811-13"/);
...
assert.match(worker, /tcloud-shell-20260811-4/);
