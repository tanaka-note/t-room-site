...
for (const [source, runtime] of [
  ["cloud.js", "cloud-runtime-20260814-10.js"],
  ["cloud.css", "cloud-runtime-20260814-10.css"],
...
assert.match(html, /name="tcloud-build" content="20260814-10"/);
assert.match(html, /name="troom-app-build" content="20260814-10"/);
...
assert.match(client, /const APP_BUILD_ID = "20260814-10"/);
