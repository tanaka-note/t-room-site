...
for (const [source, runtime] of [
  ["cloud.js", "cloud-runtime-20260811-31.js"],
  ["cloud.css", "cloud-runtime-20260811-9.css"],
...
assert.match(html, /name="tcloud-build" content="20260811-31"/);
...
assert.match(client, /const APP_BUILD_ID = "20260811-31"/);
