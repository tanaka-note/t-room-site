...
assert.ok(manifest.icons.every((icon) => icon.src.includes("?v=20260810-2")), "既存PWAへ新しいアイコンURLを通知してください。");

assert.match(html, /rel="manifest" href="\/cloud\/manifest\.webmanifest\?v=20260810-4"/);
assert.match(html, /apple-touch-icon\.png\?v=20260810-2/);
...
assert.match(worker, /icon-192\.png\?v=20260810-2/);
