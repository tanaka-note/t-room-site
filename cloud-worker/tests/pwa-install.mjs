...
for (const [source, runtime] of [
  ["cloud.js", "cloud-runtime-20260814-6.js"],
  ["cloud.css", "cloud-runtime-20260814-6.css"],
  ...
  ["share.js", "share-runtime-20260814-3.js"],
  ["share.css", "share-runtime-20260814-3.css"]
]) {
  assert.deepEqual(
...
assert.match(html, /name="tcloud-build" content="20260814-6"/);
assert.match(html, /name="troom-app-build" content="20260814-6"/);
...
assert.match(client, /const APP_BUILD_ID = "20260814-6"/);
