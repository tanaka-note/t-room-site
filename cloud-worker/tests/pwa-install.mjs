...
for (const [source, runtime] of [
  ["cloud.js", "cloud-runtime-20260814-7.js"],
  ["cloud.css", "cloud-runtime-20260814-7.css"],
  ...
  ["share.js", "share-runtime-20260814-4.js"],
  ["share.css", "share-runtime-20260814-4.css"]
]) {
  assert.deepEqual(
...
assert.match(html, /name="tcloud-build" content="20260814-7"/);
assert.match(html, /name="troom-app-build" content="20260814-7"/);
...
assert.match(client, /const APP_BUILD_ID = "20260814-7"/);
