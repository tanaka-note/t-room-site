...
for (const [source, runtime] of [
  ["cloud.js", "cloud-runtime-20260811-15.js"],
  ["cloud.css", "cloud-runtime-20260811-7.css"],
  ["offline-store.js", "offline-store-20260811-2.js"],
  ["media-client.js", "media-client-20260811-3.js"],
  ["media-worker.js", "media-worker-20260811-6.js"],
  ["manifest.webmanifest", "manifest-20260811-1.webmanifest"],
  ["share.js", "share-runtime-20260811-42.js"],
  ["share.css", "share-runtime-20260811-19.css"]
]) {
  assert.deepEqual(
...
assert.match(html, /name="tcloud-build" content="20260811-15"/);
...
assert.match(client, /const APP_BUILD_ID = "20260811-15"/);
...
assert.match(worker, /tcloud-shell-20260811-6/);
