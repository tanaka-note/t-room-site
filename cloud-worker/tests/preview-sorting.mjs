...
assert.doesNotMatch(mainJs, /screen\.orientation|webkitbeginfullscreen|webkitendfullscreen/, "管理画面から端末標準の全画面・回転処理へ介入しないでください。");
assert.doesNotMatch(shareJs, /screen\.orientation|webkitbeginfullscreen|webkitendfullscreen/, "共有画面から端末標準の全画面・回転処理へ介入しないでください。");
