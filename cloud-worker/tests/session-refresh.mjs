...
assert.match(config, /"SESSION_TTL_SECONDS"\s*:\s*"43200"/, "管理者のログイン期限が12時間ではありません。");
assert.match(config, /"SUBADMIN_SESSION_TTL_SECONDS"\s*:\s*"43200"/, "副管理者のログイン期限が12時間ではありません。");
