...
assert.match(serviceWorker, /troom-diary-shell-v48/);
assert.match(serviceWorker, /diary\.css\?v=29/);
assert.match(serviceWorker, /troom-date-picker\.css\?v=1/);
assert.match(serviceWorker, /troom-date-picker\.js\?v=1/);
assert.match(serviceWorker, /diary\.js\?v=54/);
