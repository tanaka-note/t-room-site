...
assert.ok(serviceWorker.includes(`/diary/diary-photo-processing.js?v=${build}`));
assert.ok(serviceWorker.includes(`/diary/diary-photo-upload.js?v=${build}`));
assert.ok(serviceWorker.includes(`/diary/diary-rich-text.js?v=${build}`));
assert.match(script, /diary-search\.js\$\{scriptUrl\.search\}/);
assert.match(script, /diary-photo-processing\.js\$\{scriptUrl\.search\}/);
assert.match(script, /diary-photo-upload\.js\$\{scriptUrl\.search\}/);
...
assert.match(worker, /\["\/diary-photo-processing\.js", "\/diary-photo-processing\.js"\]/);
