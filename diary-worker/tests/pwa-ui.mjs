...
assert.match(serviceWorker, /troom-diary-shell-v44/);
assert.match(serviceWorker, /diary\.css\?v=26/);
assert.match(serviceWorker, /troom-date-picker\.css\?v=1/);
assert.match(serviceWorker, /troom-date-picker\.js\?v=1/);
assert.match(serviceWorker, /diary\.js\?v=52/);
