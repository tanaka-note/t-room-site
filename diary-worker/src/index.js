...
async function serveAsset(request, env, url, path) {
  ...
  const assetPaths = new Map([
    ...
    ["/icons/diary-icon-source-v5.png", "/icons/diary-icon-source-v5.png"],
    ...
    ["/icons/icon-192-v5.png", "/icons/icon-192-v5.png"],
    ...
    ["/icons/icon-512-v5.png", "/icons/icon-512-v5.png"],
    ...
    ["/icons/icon-maskable-512-v5.png", "/icons/icon-maskable-512-v5.png"],
    ...
    ["/icons/apple-touch-icon-v4.png", "/icons/apple-touch-icon-v4.png"],
    ...
    ["/icons/favicon-64-v5.png", "/icons/favicon-64-v5.png"],
